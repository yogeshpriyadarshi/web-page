  ...
  return (
    <>
      <section id="skill" className="text-white min-h-screen">
        ...
        <div className="mx-20 grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          <div className="sm:h-30  sm:w-30 h-35 w-50 flex flex-col justify-center items-center  bg-gray-800 border-2 shadow-2xl shadow-blue-500/50 rounded-2xl hover:bg-blue-200/50">
            <img
